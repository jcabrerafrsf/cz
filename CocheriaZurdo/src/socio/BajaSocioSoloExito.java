 ...
 * @author juani
 */
public class BajaSocioSoloExito extends javax.swing.JFrame {

    /**
     * Creates new form BajaUserSoloExito
     */
    public BajaSocioSoloExito() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BajaSocioSoloExito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BajaSocioSoloExito().setVisible(true);
            }
        });
    }
